...
export default function FooterSection(){
    ...
    return(
        <footer className=" w-full bg-rose-500  flex  justify-center   ">
            <div className=" w-[100%] min-h-[50vh] bg-[rgb(22,38,39)] rounded-t-xl  py-8 px-[4%] flex md:flex-row flex-col ">
                    ...
                    <div className=" py-10 flex flex-col gap-2 pl-[10%]">
                        ...
                        <div className=" pl-[6%] space-y-4">
                            <div className=" flex gap-2 " onClick={()=>getGoogleMapsDirectionsUrl("SAI NIT-JIT PLAZA , Second Floor,Plot No.10,Beltarodi Ed. nr. GULMOHAR RESTAURANT, Manish Nagar,Somalwar , nagpur,MH-440037")}>
                                ...
                                <p className=" w-full md:w-[50%] text-zinc-400"> 401, Indu-yash Complex, Shivaji Nagar, Ram Nagar Square, Nagpur MH - 440010</p>
                            </div>
