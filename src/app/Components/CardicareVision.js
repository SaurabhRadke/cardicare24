            ...
            <div className="container mx-auto px-4 py-16">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-8">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left md:pt-0 pt-[5%] mt-[5%]">
                        ...
                        To become a global leader in cardiovascular health by advancing treatments, inspiring healthier communities, and promoting lifelong heart wellness. At Cardicare Clinic, your heart health is our passion.                        </div>
                        </div>
                        {/* Cards grid */}
